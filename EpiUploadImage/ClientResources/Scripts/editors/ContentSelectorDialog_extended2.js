...
// Resources
    ...
    return declare("extended.editors.ContentSelectorDialog_extended2", [_LayoutWidget, _ActionProviderWidget], {
        // summary:
        ...
        buildRendering: function () {
            ...
            var onlyFolders = ["episerver.core.contentfolder"];
            this.tree = new ContentTree({
                roots: roots,
                typeIdentifiers: onlyFolders,
                allowManipulation: false,
                model: model,
                allowedTypes: lang.clone(onlyFolders),
